  ...
  return (
    <main>
      <section className="z-10 flex flex-col items-center gap-10 md:gap-14">
        <div className="flex items-center justify-center gap-4 px-3 pb-10 pt-20 text-center md:px-48 md:pb-10 md:pt-14">
          <div className="flex flex-col items-center justify-center gap-4 md:gap-8">
            <div className="grid gap-3 md:gap-6">
              <h1 className="text-4xl font-medium tracking-tighter text-foreground md:text-6xl">
                Your All-in-One Learning Platform
              </h1>
              <p className="px-8 text-center text-foreground/70 md:text-lg">
        ...
        <div className="flex h-[90%] w-[90%] items-center justify-center rounded-2xl shadow-lg md:h-auto md:w-auto">
          <Image
            src={heroImage}
            width={0}
            height={0}
      ...
      <section className="mx-6 mb-4 mt-20 grid items-center justify-center gap-16 md:mx-10 md:mb-12 md:mt-24 md:gap-24 lg:mx-20">
      ...
      >
        <h2 className="text-center text-foreground">Features</h2>
        <div className="grid w-full items-start gap-x-12 gap-y-4 md:grid-cols-2 md:gap-y-24">
          <div className="flex flex-col items-start gap-2">
            <p className="rounded-xl border bg-foreground/10 px-2 py-1 text-xs text-primary shadow-sm">
              Make feedback more impactful
            </p>
            <h4 className="text-3xl font-medium text-foreground md:text-4xl">
              Visual feedback
            </h4>
          ...
          <div className="relative overflow-hidden">
            <div className="h-[20rem]">
              <div className="h-full overflow-hidden text-pretty rounded-t-md border border-x border-t">
                <p className="ml-3 mt-3 text-xs font-medium">Comments</p>
                <div className="mx-3 mt-1 flex cursor-text items-center justify-between gap-2 rounded-xl border px-3 py-2 text-xs text-foreground hover:border-[#384689]">
                ...
                <div className="ml-3 mt-2 flex items-start gap-2 pr-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs">
                      ...
                      reactions. I understand they happen in the thylakoid
                      membrane, but I&apos;m not sure about the specific steps
                      and how energy is transferred. Can you clarify?
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-12 flex flex-col items-start gap-2 md:order-2 md:mt-0">
            ...
            <p className="text-foreground/70">
              ...
              chat, you can discuss projects, answer questions, and share
              updates without the distraction of external messaging apps.
            </p>
          </div>
          <div className="relative overflow-hidden md:order-1">
            <div className="h-[20rem]">
              <div className="h-full overflow-hidden text-pretty rounded-t-md border border-x border-t pr-3">
                  ...
                  <div className="mt-0.5 flex overflow-hidden">
                    ...
                    <div className="flex w-full items-center justify-between rounded-xl border px-2 py-2">
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        strokeWidth={2}
                        className="hidden size-4 flex-shrink-0 stroke-[#22317c] hover:stroke-primary/90 md:block"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="ml-3 mt-3 grid gap-0.5">
                    ...
                    <div className="flex gap-1">
                      ...
                      <p className="rounded-xl border px-2 py-1 text-xs">
                        ...
                        electrons? Do they just go back to their original state?
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="h-full overflow-hidden text-pretty rounded-t-md border border-x border-t">
                ...
                <div className="mx-3 mt-2 grid gap-1">
                  <p className="text-xs">
                    ...
                    absorbs another photon producing a more highly reducing
                    electron, which converts NADP+ to NADPH. In oxygenic
                    photosynthesis, the first electron donor is water, creating
                    oxygen (O2) as a by-product. In anoxygenic photosynthesis,
                    various electron donors are used. Cytochrome b6f and ATP
                    synthase work together to produce ATP (photophosphorylation)
                    in two distinct ways. In non-cyclic photophosphorylation,
                    cytochrome b6f uses electrons from PSII and energy from
                    PSI[citation needed] to pump protons from the stroma to the
                    lumen. The resulting proton gradient across the thylakoid
                    membrane creates a proton-motive force, used by ATP synthase
                    to form ATP. In cyclic photophosphorylation, cytochrome b6f
                    uses electrons and energy from PSI to create more ATP and to
                    stop the production of NADPH. Cyclic phosphorylation is
                    important to create ATP and maintain NADPH in the right
                    proportion for the light-independent reactions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 flex flex-col items-start gap-2 md:order-6 md:mt-0">
            ...
            <p className="text-foreground/70">
              Experience the core functionalities of a learning management
              system in a way that feels familiar yet more efficient. With an
              intuitive interface, you&apos;ll navigate through tasks,
              assignments, and communication with ease. The refined workflow
              reduces complexity, allowing you to focus on what really
              matters—managing your classroom effectively without unnecessary
              distractions.
            </p>
          </div>
          <div className="relative overflow-hidden md:order-5">
            <div className="h-[20rem]">
              <div className="h-full overflow-hidden text-pretty rounded-t-md border border-x border-t px-3 py-3">
                ...
                <div className="mt-2 flex items-center gap-2 rounded-xl border px-2 py-2 text-xs text-foreground shadow-sm">
                  ...
                  />
                  <p className="text-foreground/70">Share with your class...</p>
                </div>
                ...
                <div className="mt-2 flex items-center gap-2 rounded-xl border px-2 py-2 text-xs font-medium shadow-sm">
                  ...
                  <p className="text-foreground/70">Surface Integrals</p>
                </div>
                <div className="mt-2 flex items-center gap-2 rounded-xl border px-2 py-2 text-xs font-medium shadow-sm">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="mx-6 mb-24 flex items-center justify-center text-center md:mx-24 lg:mx-32">
        <div className="flex flex-col items-center justify-center gap-2 md:gap-4">
          <h4 className="text-3xl font-semibold tracking-tighter text-foreground md:text-5xl">
            Learning without the hassle
          </h4>
          <p className="px-2 text-center text-base text-foreground/70">
