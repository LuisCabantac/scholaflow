...
export default function Sidebar({
  ...
  return (
    <nav className="relative">
      ...
      <div
        className={`fixed h-screen overflow-y-auto ${sidebarExpand ? "w-64 px-3 md:w-64" : "w-0 md:w-20 md:px-3"} border-sidebar-border bg-sidebar left-0 top-0 z-30 rounded-r-md border-r py-5 transition-all duration-300 ease-in-out md:static`}
      >
        <div className="flex items-center justify-between pl-3">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              strokeWidth={2}
              className="stroke-sidebar-ring hidden size-7 md:block"
            >
