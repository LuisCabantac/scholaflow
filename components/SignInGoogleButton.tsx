...
export default function SignInGoogleButton() {
  return (
    <button
      className="flex h-10 w-full items-center justify-center gap-2 rounded-md bg-[#e1e7f5] px-4 py-2 text-sm font-medium text-[#22317c] transition-colors hover:bg-[#d9dfee] disabled:bg-[#c5cde6]"
      onClick={async () => {
        await signIn.social({
          provider: "google",
