...
export default function SignInGoogleButton() {
  return (
    <form action={signInGoogleAction}>
      <button className="flex w-full items-center justify-center gap-2 rounded-md border-2 border-[#dbe4ff] bg-[#e1e7f5] px-[1.12rem] py-[0.65rem] text-sm font-semibold text-[#22317c] transition-colors hover:bg-[#d9dfee] disabled:bg-[#c5cde6]">
