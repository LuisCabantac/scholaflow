    ...
    >
      {showEdit && (
        <div>
          <button
            type="button"
            className="flex w-full items-center gap-1 rounded-md text-sm text-[#4c6ef5] hover:text-[#364fc7] md:text-base"
      ...
      <button
        onClick={onShowConfirmationScreen}
      ...
      >
        ...
        <span>{deleteLabel ? deleteLabel : "Delete"}</span>
      </button>
    </div>
  );
}
