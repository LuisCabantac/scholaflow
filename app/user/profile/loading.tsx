      ...
      <div className="grid gap-4 rounded-md border border-[#dddfe6] bg-[#f3f6ff] p-3 md:p-4">
        ...
        <div className="flex flex-col items-start justify-start gap-2 md:flex-row md:items-center md:justify-between">
          <div className="mt-0.5 grid gap-2 md:flex md:items-center">
            <div>
              <div className="mb-1.5 h-[0.875rem] w-48 animate-pulse rounded-md bg-[#dbe4ff]"></div>
            ...
            <div>
              <div className="mb-1.5 h-[0.875rem] w-20 animate-pulse rounded-md bg-[#dbe4ff]"></div>
              <div className="h-[0.75rem] w-12 animate-pulse rounded-md bg-[#dbe4ff]"></div>
            </div>
            <div className="mx-4 hidden h-8 w-px bg-[#dbe4ff] md:block"></div>
            <div>
              <div className="mb-1.5 h-[0.875rem] w-24 animate-pulse rounded-md bg-[#dbe4ff]"></div>
              <div className="h-[0.75rem] w-12 animate-pulse rounded-md bg-[#dbe4ff]"></div>
            </div>
          </div>
        </div>
