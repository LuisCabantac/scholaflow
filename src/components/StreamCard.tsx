        ...
        <>
          ...
          {(classroom.allowUsersToComment ||
            ...
            <>
              ...
              >
                <div className="flex h-9 w-full items-center justify-between rounded-xl border bg-foreground/10 px-4 py-2 text-muted-foreground">
